...
export function ConversationCanvas() {
  ...
  function submitUserMessage(text: string) {
    ...
    setInput("");
    // naive match — find an insight whose followUps contain this prompt
    ...
    const reply: AgentTurnType = match
      ...
      : {
          ...
          role: "agent",
          content:
            "I don't have strong evidence for that yet. Try one of the follow-ups on the right, or pick a metric lens above.",
        };
    setQueue((q) => [...q, reply]);
  }
      ...
      <div className="flex items-center justify-between border-b border-[color:var(--mc-border)] px-5 py-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="mc-micro">Grounded in this campaign · No actions without review</p>
          </div>
        </div>
